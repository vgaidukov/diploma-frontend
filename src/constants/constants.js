...
export const MOVIES_START_5 = 5;
export const MOVIES_START_8 = 8;
export const MOVIES_START_12 = 12;
export const MOVIES_ADD_2 = 2;
export const MOVIES_ADD_3 = 3;

export const TABLET_580 = 580;
export const DESKTOP_995 = 995;
